        ...
        try {
          ...
          UserName= sess.getAttribute("name").toString();
                ...
                try {
                    ...
                    response.sendRedirect("FetchInfo.Do?err=2");
                    i = 1;
                }
                if (i == 0) {
                    ...
                    if (new PersonalInfoAction().updateInfo(data)) {
                        response.sendRedirect("FetchInfo.Do?err=3");
                    } else {
                        response.sendRedirect("FetchInfo.Do?err=4");
                    }
                }
