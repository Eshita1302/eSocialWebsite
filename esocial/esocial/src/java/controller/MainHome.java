 ...
 * @author Esh
 */
@WebServlet(name="MainHome", urlPatterns={"/MainHome.Do"})
    ...
    throws ServletException, IOException {
        ...
        try {
            HttpSession sess = request.getSession();
                    ...
                    List<StatusData> data = new StatusTableAction().showMyStatus((String) sess.getAttribute("name"));
                    sess.setAttribute("mystat", data);
