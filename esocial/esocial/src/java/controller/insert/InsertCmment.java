 ...
 * @author Esh
 */
@WebServlet(name = "InsertCmment", urlPatterns = {"/InsertComment.Do"})
public class InsertCmment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (UserName == null || commentText == null) {
                ...
                StatusCommData data = new StatusCommData();
                int i = 0;
                try {
                ...
                if (i == 0) {
                    ...
                    data.setStatusID(statusID);
                    new StatusCommAction().InsertStatus(data);
